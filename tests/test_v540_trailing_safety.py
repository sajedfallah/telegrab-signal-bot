...
TR=(ROOT/"mt5/NEXUS_AutoTrade_UI65/Core/Include/TrailingEngine.mqh").read_text(encoding="utf-8")
TYPES=(ROOT/"mt5/NEXUS_AutoTrade_UI65/Core/Include/NexusTypes.mqh").read_text(encoding="utf-8")
