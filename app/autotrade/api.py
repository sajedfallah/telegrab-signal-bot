...
class TradeEventRequest(BaseModel):
    ...
    remaining_volume: float = Field(default=0.0, ge=0.0, le=1_000_000)
...
def trade_event(
    ...
    payload = {
        ...
        "event_subtype": str(req.event_subtype or "").strip().upper(),
        "remaining_volume": float(req.remaining_volume or 0.0),
