...
class TradeEventRequest(BaseModel):
    ...
    event_subtype: str = Field(default="", max_length=64)
    remaining_volume: float | None = Field(default=None, ge=0.0, le=1_000_000)
    sl_before: float | None = Field(default=None, ge=0.0, le=1e12)
    sl_after: float | None = Field(default=None, ge=0.0, le=1e12)
    tp_before: float | None = Field(default=None, ge=0.0, le=1e12)
    tp_after: float | None = Field(default=None, ge=0.0, le=1e12)
    spread: float = Field(default=0.0, ge=0.0, le=1e12)
    latency_ms: int = Field(default=0, ge=0, le=3_600_000)
    mfe_price: float | None = Field(default=None, ge=0.0, le=1e12)
    mae_price: float | None = Field(default=None, ge=0.0, le=1e12)
    mfe_r: float | None = Field(default=None, ge=-1e9, le=1e9)
    mae_r: float | None = Field(default=None, ge=-1e9, le=1e9)
    config_snapshot: dict = Field(default_factory=dict)
