...
from .provider_branding_api import router as provider_branding_router
...
from .provider_reports_api import router as provider_reports_router
...
app.include_router(provider_reports_router)
app.include_router(provider_branding_router)
