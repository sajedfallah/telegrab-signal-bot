...
class AcademyMentorAgent:
    ...
    async def build_for_day(self, day: date) -> int:
        ...
        # Three deterministic NEXUS-branded slides: concept, key points, exercise.
        slides: list[bytes] = []
        slides.append(render_post_card(draft, hero_image_bytes=hero))
        ...
        exercise_draft.key_points = [
            "یک نمودار واقعی باز کن.",
            "مفهوم امروز را روی نمودار علامت بزن.",
            "دلیل انتخابت را در یک جمله بنویس.",
        ]
